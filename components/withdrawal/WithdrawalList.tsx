...
const WithdrawalList = ({ retrieve = RetrievalType.RECENT }: WithdrawalListProps) => {
    ...
    return (
        <section
            ...
            {/* Table */}
            <div className="overflow-x-auto rounded-xl shadow-md border border-gray-200 dark:border-gray-700 mt-10">
                <table className="w-full text-sm text-left text-gray-700 dark:text-gray-200">
                    <thead className="text-xs uppercase bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300">
                        <tr>
                            {['Date', 'Transaction ID', 'Amount', 'Business', 'Status'].map((heading) => (
